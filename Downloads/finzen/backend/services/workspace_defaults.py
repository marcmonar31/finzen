...
CATEGORIAS_DEFAULT = [
    # ── Ingresos ──────────────────────────────────
    {"nombre": "Nómina", "tipo": "ingreso", "emoji": "💼", "color": "#C7FF6B"},
    {"nombre": "Freelance", "tipo": "ingreso", "emoji": "💻", "color": "#C7FF6B"},
    {"nombre": "Inversiones", "tipo": "ingreso", "emoji": "📈", "color": "#C7FF6B"},
    {"nombre": "Regalos", "tipo": "ingreso", "emoji": "🎁", "color": "#C7FF6B"},
    {"nombre": "Otros ingresos", "tipo": "ingreso", "emoji": "➕", "color": "#C7FF6B"},
    # ── Gastos (padres) ───────────────────────────
    {"nombre": "Vivienda", "tipo": "gasto", "emoji": "🏠", "color": "#4A90E2", "hijos": [
        "Alquiler", "Hipoteca", "Suministros", "Mantenimiento",
    ]},
    {"nombre": "Comida", "tipo": "gasto", "emoji": "🍽️", "color": "#FF9A4D", "hijos": [
        "Supermercado", "Restaurantes", "Cafés", "Delivery",
    ]},
    {"nombre": "Transporte", "tipo": "gasto", "emoji": "🚗", "color": "#B57BFF", "hijos": [
        "Combustible", "Transporte público", "Taxi", "Mantenimiento coche",
    ]},
    {"nombre": "Salud", "tipo": "gasto", "emoji": "❤️", "color": "#FF5C5C", "hijos": [
        "Médico", "Farmacia", "Seguros",
    ]},
    {"nombre": "Ocio", "tipo": "gasto", "emoji": "🎮", "color": "#FFD84D", "hijos": [
        "Cine", "Suscripciones", "Viajes", "Eventos",
    ]},
    {"nombre": "Personal", "tipo": "gasto", "emoji": "👤", "color": "#FF6BB5", "hijos": [
        "Ropa", "Belleza", "Regalos",
    ]},
    {"nombre": "Educación", "tipo": "gasto", "emoji": "📚", "color": "#4DD8C7", "hijos": [
        "Cursos", "Libros", "Material",
    ]},
    {"nombre": "Otros gastos", "tipo": "gasto", "emoji": "📦", "color": "#B0B0B4"},
]
